...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '𝔑𝔦𝔤𝔯𝔬𝔪𝔞𝔫𝔱𝔢𝔅𝔬𝔱-𝔐𝔇', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/sinombre913/NigromanteBot-MD'}, mentionedJid: [m.sender]}}}, aa);
