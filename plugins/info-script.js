...
const handler = async (m, { conn, args }) => {
   const res = await fetch('https://api.github.com/repos/sinombre913/NigromanteBot-MD');
   const json = await res.json();
   let txt = `           *乂  B O T S C R I P T  乂*\n\n`;
      txt += `◦  *Nombre:* ${json?.name || '❥ᰰຼ ⃟ᬽ៸𝔑𝔦𝔤𝔯𝔬𝔪𝔞𝔫𝔱𝔢𝔅𝔬𝔱-𝔐𝔇༒★»'}\n`;
      ...
      txt += `◦  *Url:* ${json?.html_url || 'https://github.com/sinombre913/NigromanteBot-MD'}\n\n`;
