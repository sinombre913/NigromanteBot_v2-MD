...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '❥ᰰຼ ⃟ᬽ៸ 𝔑𝔦𝔤𝔯𝔬𝔪𝔞𝔫𝔱𝔢𝔅𝔬𝔱-𝔐𝔇༒★', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '❥ᰰຼ ⃟ᬽ៸ 𝔑𝔦𝔤𝔯𝔬𝔪𝔞𝔫𝔱𝔢𝔅𝔬𝔱-𝔐𝔇༒★', 'jpegThumbnail': false}}};
