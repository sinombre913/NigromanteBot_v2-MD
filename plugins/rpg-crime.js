const handler = async (m, {conn, isPrems}) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 60000) throw `*¡Espera un momento pequeño!* \n\n*—◉ Regresa en ${msToTime(time - new Date())} ⏳*`;
  conn.sendMessage(m.chat, {text: `*Tu Crimen Ha Sido:*\n\n *${pickRandom(global.crime)}*\n*¡ !${hasil} exp!*`}, {quoted: m});
...
global.crime = [
  ...
  'Vas De Paseo Al Mar y Miras Un Yate Decides Robarlo Y Venderlo A La Mitad De Su Presio Obtienes --------- xp.',
